export function renderMultiChannelViewSettings(container, { context }) {
    ...
    description.textContent = 'Fonctionnalité alpha : le canal actif reste natif. Un bouton + apparaît sur les canaux rejoints pour ouvrir jusqu’à trois canaux supplémentaires, avec une disposition adaptée automatiquement.';
